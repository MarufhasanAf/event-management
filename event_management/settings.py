...
DATABASES = {
    'default': dj_database_url.config(
        ...
        default='postgresql://event_management_db_orbg_user:V4x4mGAETQNEIcUoajBnIxM7cH0i46Wo@dpg-cv7i06q3esus739nrh30-a.oregon-postgres.render.com/event_management_db_orbg',
        conn_max_age=600
    )
}
